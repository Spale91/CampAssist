...
namespace CampAssist
{
    ...
    public partial class CampAssistDBEntities : DbContext
    {
        public CampAssistDBEntities()
            : base("name=CampAssistDBEntities")
        {
        }
        ...
        public virtual DbSet<AccommodationUnitGuest> AccommodationUnitGuests { get; set; }
